...
import org.apache.flink.streaming.api.scala.extensions.impl.acceptPartialFunctions.{OnConnectedStream, OnDataStream, OnJoinedStream, OnKeyedStream, OnWindowedStream}
