...
/**
 * {@code String}类表示字符串。Java程序中的所有字符串文本，如{@code“abc”}，都实现为此类的实例。
 * <p>
...
public final class String
	...
	/**
     * 初始化新创建的{@code String}对象，使其表示空字符序列。
     *
	...
	/**
     * 返回{@code true}当且仅当{@link#length（）}为{@code 0}。
     * @如果{@link#length（）}为{@code 0}，则返回{@code true}，否则返回{@code false}
     *
	...
	/**
     * 返回此{@code String}的指定文本范围内的Unicode码点数。
     *
	...
	/**
     * 返回此{@code String}中的索引，该索引从给定的{@code index}偏移了{@code codePointOffset}个代码点。
     *
	...
	/**
     * 将{@code String}对象按{@code compareTignoreCase}排序的比较器。这个比较器是可串行化的。
     *
	...
	/**
     * 返回由{@code CharSequence elements}的副本和指定的{@code delimiter}的副本组成的新字符串。
     *
