...
/**
  * Java实现[[TimSort]]上的简单包装器。
  * Java实现是包私有的，因此不能在包外调用它org.apache.spark网站.使用集合. 这是一个可用于spark的简单包装。
  *
  ...
  * org.apache.org.apache.spark.util.collection. This is a simple wrapper of it that is available to org.apache.spark.
  */
private[spark]
