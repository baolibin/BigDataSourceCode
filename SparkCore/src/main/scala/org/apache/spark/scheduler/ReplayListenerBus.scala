...
/**
  * 一种SparkListenerBus，可用于从序列化事件数据重播事件。
  *
                ...
                try {
                    ...
                    case e: UnrecognizedPropertyException if e.getMessage != null && e.getMessage.startsWith(
                        "Unrecognized field \"queryStatus\" " +
                                "(class org.apache.org.apache.spark.sql.streaming.StreamingQueryListener$") =>
...
private[spark] object ReplayListenerBus {
    ...
    val KNOWN_REMOVED_CLASSES = Set(
        "org.apache.org.apache.spark.sql.streaming.StreamingQueryListener$QueryProgress",
        "org.apache.org.apache.spark.sql.streaming.StreamingQueryListener$QueryTerminated"
    )
}
