...
/**
 * 状态描述符的基类。{@code StateDescriptor}用于在有状态操作中创建分区的{@link State}。
 * <p>
...
public abstract class StateDescriptor<S extends State, T> implements Serializable {
	...
	/**
	 * 支持状态类型的枚举。用于在写入和还原检查点和保存点时标识状态类型。
	 * <p>
	...
	/**
	 * 针对从此StateDescriptor创建的状态的查询的名称。
	 * <p>
