        ...
        val content =
            <div class="row-fluid">
                ...
                <div class="span12">
                    <ul class="unstyled">
                        <li>
                            <strong>ID:</strong>{workerState.workerId}
                        </li>
                        <li>
                            <strong>
                        ...
                        <li>
                            <strong>Cores:</strong>{workerState.cores}
                            (
                            {workerState.coresUsed}
                            Used)</li>
                        <li>
                            <strong>Memory:</strong>{Utils.megabytesToString(workerState.memory)}
                            (
                            {Utils.megabytesToString(workerState.memoryUsed)}
                            Used)</li>
                    </ul>
                    <p>
                        <a href={workerState.masterWebUiUrl}>Back to Master</a>
                    </p>
                </div>
            </div>
                    <div class="row-fluid">
                        ...
                        <div class="span12">
                            <h4>Running Executors (
                                ...
                                )</h4>{runningExecutorTable}{if (runningDrivers.nonEmpty) {
                            <h4>Running Drivers (
                                {runningDrivers.size}
                                )</h4> ++
                                    runningDriverTable
    ...
    def executorRow(executor: ExecutorRunner): Seq[Node] = {
        <tr>
            ...
            <td>
                <ul class="unstyled">
                    <li>
                        <strong>ID:</strong>{executor.appId}
                    </li>
                    <li>
                        <strong>Name:</strong>{executor.appDesc.name}
                    </li>
                    <li>
                        <strong>User:</strong>{executor.appDesc.user}
                    </li>
                </ul>
            </td>
            <td>
