...
/**
  * 一个[[Column]]，其中为预期的输入和返回类型提供了一个[[Encoder]]。
  * 要创建[[TypedColumn]]，请在[[Column]]上使用'as'函数。
  *
...
class Column(val expr: Expression) extends Logging {
    ...
    /**
      ...
      * @since 2.1.0
      */
    def desc_nulls_first: Column = withExpr {
    ...
    /**
      ...
      * @since 2.1.0
      */
    def desc_nulls_last: Column = withExpr {
    ...
    /**
      ...
      * @since 2.1.0
      */
    def asc_nulls_first: Column = withExpr {
    ...
    /**
      ...
      * @since 2.1.0
      */
    def asc_nulls_last: Column = withExpr {
    ...
    /**
      * 定义一个空的分析子句。在这种情况下，将应用分析函数并为结果集中的所有行显示。
      *
