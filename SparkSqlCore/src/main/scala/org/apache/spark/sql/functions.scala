...
object functions {
    ...
    /**
      ...
      * @since 2.1.0
      */
    def degrees(e: Column): Column = withExpr {
        ToDegrees(e.expr)
    }
    ...
    /**
      ...
      * @since 2.1.0
      */
    def radians(e: Column): Column = withExpr {
        ToRadians(e.expr)
    }
    ...
    /**
      ...
      * @since 2.2.0
      */
    def explode_outer(e: Column): Column = withExpr {
        GeneratorOuter(Explode(e.expr))
    }
    ...
    /**
      ...
      * @since 2.2.0
      */
    def posexplode_outer(e: Column): Column = withExpr {
        GeneratorOuter(PosExplode(e.expr))
    }
